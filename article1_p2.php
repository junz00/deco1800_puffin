		...
		<section id="book">
			...
			<div id="pages">
				<div id="leftpage">
					...
					<article>
						<p>Sandbags correctly placed appropriately around the home <mark title="According to the Qld gov, they 'significantly reduce the impact of flooding'">are one of the most effective defences against flooding</mark>.</p> 
						...
						<p>They can be purchased from your local hardware
								store or are distributed by your local Council or by <mark title="State Emergency Service">SES</mark> in an emergency flood.</p>
